    ...
    return (
      <div className="flex-1 overflow-y-auto min-h-0 flex flex-col p-3 sm:p-4 md:p-6 pb-20 sm:pb-6">
        ...
        >
          ...
          {/* Feature cards — hidden on mobile, 3 columns on desktop */}
          <div className="hidden sm:grid grid-cols-3 gap-2 sm:gap-2 md:gap-3 mb-3 sm:mb-5 md:mb-8">
          ...
          {/* Suggestion prompts — hidden on mobile */}
          <div className="hidden sm:block space-y-1.5 sm:space-y-2">
            <p className="text-[10px] sm:text-[11px] md:text-xs font-medium text-muted-foreground uppercase tracking-wider">
              Try asking
            </p>
